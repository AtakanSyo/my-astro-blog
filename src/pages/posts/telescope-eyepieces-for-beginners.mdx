...
<p>
  Huygens and Ramsden eyepieces use two convex lens elements and produce very narrow fields of view, usually 20–35°. They are uncomfortable to use and produce poor results with anything faster than f/8 to f/10, which is why they are usually the junk supplied with beginner telescopes—Ramsdens can be on the verge of acceptable, but generally aren’t something we’d recommend using. The Kellner is essentially an upgraded Ramsden with a field of view typically spanning 40–50°. It is a lot sharper and more comfortable than a Ramsden, but still has some issues with sharpness even at the center of the field, and with fast instruments the view is not the best. The RKE or “Reverse Kellner” is commonly mislabeled as a Kellner, but performs quite a bit better, offering slightly better correction and more eye relief.
</p>

<p>If you’re unable to find out the specs of an eyepiece directly, the name of the eyepiece might give you a clue:</p>

<p>
  Most “planetary” or “super” eyepieces are Plossls or Kellners, maybe with an extra lens element or two added. “Wide-angle” generally refers to 60–70° of apparent field and usually indicates some variant on the Erfle or Bertele design. “Super-wide angle” generally refers to 65–75° of apparent field and is also typically an Erfle derivative. “Ultra-wide angle” generally refers to 80–90° of apparent field; these eyepieces are either Naglers or close copycats for the most part. “Hyperwide,” “extra wide angle,” or “mega-wide angle” generally refers to eyepieces with a field of view of around 90–100° or more, most of which are some variant on the Ethos.
</p>

<p>Since most mass-produced eyepieces are copies of somebody else’s design—either the more “classic” variants or something from Tele-Vue—the bulk of the wide-angle eyepieces tend to have standardized fields of view of 68, 72, 82, 100, or 110°, to within a few degrees of rounding error.</p>
...
<p>
  There are four standard barrel diameters for astronomical eyepieces. The 0.965” size is usually found on smaller and older telescopes and is seldom made today; most scopes that use it should probably be avoided unless you are a collector, because retrofitting is costly and quality eyepieces in this format are scarce. The 1.25” size is the most common and any good telescope should at least accept it—either directly or via a step-down adapter—and it even fits common plumbing fittings if you’re building your own scope. The 2” size is usually meant for larger telescopes, and most instruments over 6” in aperture either ship with a 2” focuser or can easily be upgraded to one. The rare 3” format appears mainly on very large, long focal length instruments such as big refractors or catadioptrics.
</p>

<p>
  The main benefit of bigger barrel diameters is the ability to capture a larger field of view. This is why most 2” eyepieces are longer in focal length than, say, 15 mm. Even extremely wide-field eyepieces with 100° or more tend to use a 1.25” barrel—or remain compatible with 1.25” focusers at shorter focal lengths—because the light cone they present is still narrow enough. Practically speaking, any telescope that accepts 2” accessories will lead you to own a mix of 1.25” and 2” oculars, which you can swap using an adapter or by employing eyepieces that have dual barrels compatible with both sizes.
</p>
