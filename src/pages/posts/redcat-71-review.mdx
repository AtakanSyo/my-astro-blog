...
affiliate:
  ...
  highpointscientific: ""
  astroshop: "https://www.astroshop.eu/telescopes/william-optics-apochromatic-refractor-ap-71-350-redcat-71-ota/p,73030"
cover_image: "/images/redcat-71-review/cover.webp"
specs:
  aperture: "71"
  focalLength: "350"
pubDate: "2025-07-25"
description: "Like the smaller RedCat 51, the William Optics RedCat 71 is a high-quality imaging refractor that combines the best aspects of telephoto lenses and traditional astronomical refracting telescopes into a high-quality, well-arranged, and easy-to-use package."
---
...
<section class="info-tags">
  <h3>Info Tags</h3>
  <ul>
    <li>71mm (2.8”) Aperture</li>
    <li>350mm Focal Length</li>
    <li>f/4.9</li>
...
<section class="pros-cons">
  <div class="pros-block">
    ...
    <ul>
        ...
        <li>Fairly lightweight and portable</li>
  ...
  <div class="cons-block">
    ...
    <ul>
        ...
        <li>Not designed for monochrome cameras</li>
        <li>Rather expensive</li>
        <li>Needs an HEQ5-class mount for the best results</li>
    </ul>
  </div>
</section>
