...
<section class="info-tags">
  <h3>Info Tags</h3>
  <ul>
    <li>73mm (2.8”) Aperture</li>
    <li>430mm Focal Length</li>
    <li>f/5.9</li>
...
<section class="pros-cons">
  <div class="pros-block">
    ...
    <ul>
        ...
        <li>Works with small equatorial mounts</li>
        <li>Large field of view with 35mm illuminated image circle</li>
    </ul>
  </div>
  <div class="cons-block">
    <h3>Cons</h3>
    <ul>
        <li>Short focal length limits you to larger targets</li>
        <li>Heavier than a 60-62mm refractor or telephoto lens, requiring a true equatorial mount</li>
        <li>Requires a field flattener (sold separately) for acceptable images</li>
    </ul>
  </div>
</section>
