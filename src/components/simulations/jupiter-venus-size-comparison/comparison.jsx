...
export default function PlanetSim({
  ...
  useEffect(() => {
    ...
    const secondRadiusScale = options.secondRadiusScale ?? 0.08465282829;
    ...
    const cfg = {
      ...
      secondTexture: options.secondTexture ?? '/textures/2k_venus_atmosphere.webp',
      ...
      planetContrast: options.planetContrast ?? 1.0,
      planetBrightness: options.planetBrightness ?? 0.007, // optional
