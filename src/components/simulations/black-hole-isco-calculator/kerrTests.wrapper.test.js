...
import { getKerrTestRows } from "./kerrTests";
...
// kerrTests.js for the row definitions, sources, and tolerances.
describe("black-hole-isco-calculator reference test rows", () => {
  const rows = getKerrTestRows();
