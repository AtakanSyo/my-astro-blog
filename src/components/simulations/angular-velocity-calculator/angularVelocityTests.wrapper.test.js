...
import { getAngularVelocityTestRows } from "./angularVelocityTests";
...
// angularVelocityTests.js for the row definitions, sources, and tolerances.
describe("angular-velocity-calculator reference test rows", () => {
  const rows = getAngularVelocityTestRows();
