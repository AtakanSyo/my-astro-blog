...
export async function run(canvas, { pausedRef, options = {} } = {}) {
  ...
  const TEX_ALBEDO        = options.albedoTexture ?? '/interactive/mercury/mercury_texture.jpg';
  const TEX_STARS         = options.starsTexture  ?? '/interactive/mercury/stars_texture.jpg';
