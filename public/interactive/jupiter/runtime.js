...
export async function run(canvas, { pausedRef, options = {} } = {}) {
  ...
  const TIME_SCALE       = options.timeScale ?? 1500;
  ...
  const TEX_NEPTUNE = options.neptuneTexture ?? '/interactive/jupiter/jupiter_texture.jpg';
  const TEX_STARS   = options.starsTexture   ?? '/interactive/jupiter/stars_texture.jpg';
